...
public class Config {
    ...
    {
        COPPERED_GLOW_DURATION = CLIENT_BUILDER.comment("How long the glowing lasts for coppered apples (in ticks)").defineInRange("glow_duration", 600, 100, Integer.MAX_VALUE);
    }
